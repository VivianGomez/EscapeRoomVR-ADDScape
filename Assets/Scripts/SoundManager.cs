...
public class SoundManager : MonoBehaviour
{
    ...
    Ins4L1, Ins5L1, Ins6L1, Ins7L1, Ins8L1;
    ...
    void Start()
    {
        ...
        */
        ...
        PlaySound("Ins1L1");
        StartCoroutine(CambiarInstruccionPantalla("Ins1L1", "2Ins", "3Ins", 4, 15, 3));
    }

    public IEnumerator CambiarInstruccionPantalla(string nombreAnim, string nombreInstruccion, string nombreInstruccion2, int secs, int secsAnim,int secs2)
    {
